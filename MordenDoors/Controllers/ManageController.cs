    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                TempData["ChangePassword"] = "PasswordChanged";
        ...
        {
            MordenDoorsEntities context = new MordenDoorsEntities();
            var userRoles = context.AspNetRoles.Select(s => s.Name).ToList();
            ...
            var usersWithRoles = (from user in context.AspNetUsers
                                  select new
                                  {
                                      ...
                                      Email = user.Email,
                                      Status = user.status,
                                      EmployeeNumber = user.EmoployeeNumber,
                                      LastUpdateTime = user.LastUpdateTime,
                                      RoleName = (from userRole in user.AspNetRoles
                                                  join role in context.AspNetRoles on userRole.Id
                                                  equals role.Id
                                                  select role.Name).FirstOrDefault(),
                                      Skills = (from userskills in context.EmployeeSkills
                                                join skill in context.WorkStages on userskills.SkillId equals skill.Id
            ...
            return View(usersWithRoles.OrderByDescending(x=>x.LastUpdateTime));
        }
    }
}